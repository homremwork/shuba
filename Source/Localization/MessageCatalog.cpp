...
constexpr std::array static_message_table{
	...
	StaticMessage{MessageId::WorkflowPreviewUnavailable,
				  ...
				  "Photo preview is unavailable."},
	StaticMessage{MessageId::ShellOperationBusy, "shell.operation.busy",
				  "An operation is already in progress."},
	StaticMessage{MessageId::ShellOperationHeading, "shell.operation.heading",
				  "Operation in progress"},
	StaticMessage{MessageId::ShellOperationCancel, "shell.operation.cancel",
				  "Cancel operation"},
	StaticMessage{MessageId::ShellOperationCancelling,
				  "shell.operation.cancelling",
				  "Operation cancellation requested."},
	StaticMessage{MessageId::ShellOperationFailed, "shell.operation.failed",
				  "Operation failed."},
};
...
constexpr std::array template_message_table{
	...
	PresentationMessage{"item.action.open_storage", "Open storage: {storage}"},
